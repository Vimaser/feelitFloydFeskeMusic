    ...
    try {
      ...
      if (featuredImageFile) {
        const featuredImageRef = ref(
          storage,
          `images/${featuredImageFile.name}`
        );
        const featuredImageSnapshot = await uploadBytes(
          featuredImageRef,
          featuredImageFile
        );
            ...
            {uploads.map((upload) => (
              <li key={upload.id} className="flex flex-col items-start py-2">
                <div className="flex justify-between w-full items-center">
                  ...
                  <button
                    onClick={() =>
                      handleDelete(upload.id, upload.musicURL, upload.imageURL)
                    }
                ...
                <div className="flex items-center">
                  ...
                  <AudioPlayer autoPlay={false} src={upload.musicURL} />
                </div>
              </li>
            ))}
          </ul>
